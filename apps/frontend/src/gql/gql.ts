...
const documents: Documents = {
    ...
    "\n  mutation InitiateUpiQrPayment($input: InitiateUpiQrPaymentInput!) {\n    initiateUpiQrPayment(input: $input) {\n      paymentOrderId\n      qrCodeData\n      qrCodeUrl\n      zaakpayTxnId\n      amount\n      currency\n      expiresAt\n      responseCode\n      responseMessage\n    }\n  }\n": types.InitiateUpiQrPaymentDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation InitiatePayment($input: InitiatePaymentInput!) {\n    initiatePayment(input: $input) {\n      paymentOrderId\n      checkoutUrl\n      checksumData {\n        amount\n        merchantIdentifier\n        orderId\n        buyerEmail\n        buyerFirstName\n        buyerPhoneNumber\n        currency\n        txnType\n        zpPayOption\n        mode\n        productDescription\n        txnDate\n        checksum\n      }\n    }\n  }\n"): typeof import('./graphql').InitiatePaymentDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "\n  mutation InitiateUpiQrPayment($input: InitiateUpiQrPaymentInput!) {\n    initiateUpiQrPayment(input: $input) {\n      paymentOrderId\n      qrCodeData\n      qrCodeUrl\n      zaakpayTxnId\n      amount\n      currency\n      expiresAt\n      responseCode\n      responseMessage\n    }\n  }\n"): typeof import('./graphql').InitiateUpiQrPaymentDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
